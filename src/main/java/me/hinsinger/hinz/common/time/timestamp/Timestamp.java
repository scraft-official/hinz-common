package me.hinsinger.hinz.common.time.timestamp;
...
import me.hinsinger.hinz.common.time.timestamp.json.deserializer.GsonTimestampDeserializer;
import me.hinsinger.hinz.common.time.timestamp.json.deserializer.JacksonTimestampDeserializer;
import me.hinsinger.hinz.common.time.timestamp.json.serializer.GsonTimestampSerializer;
...
public class Timestamp {
	...
	public Timestamp addDuration(Duration value) {
		return addMilliseconds(value.toMillis());
	}
