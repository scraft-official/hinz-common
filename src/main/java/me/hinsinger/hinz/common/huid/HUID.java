package me.hinsinger.hinz.common.huid;
...
import me.hinsinger.hinz.common.huid.json.deserializer.GsonHuidDeserializer;
import me.hinsinger.hinz.common.huid.json.deserializer.JacksonHuidDeserializer;
import me.hinsinger.hinz.common.huid.json.serializer.GsonHuidSerializer;
...
public class HUID {
    ...
    public static HUID fromString(@NonNull String huid) {
    	...
    	return new HUID(FastUUID.parseUUID(huid.replaceAll(ADD_UUID_HYPHENS_REGEX, "$1-$2-$3-$4-$5")));
    }
    ...
    public static boolean isHUID(String huid) {
    	return (huid != null) && (huid.matches(TRIMMED_UUID_REGEX) || huid.matches(UUID_REGEX));
    }
